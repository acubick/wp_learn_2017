...
<head>
	...
	<!-- Custom Theme files -->
	<!-- <link href="<?php echo bloginfo('template_url'); ?>/assets/css/style.css" rel="stylesheet" type="text/css" media="all" /> -->
	<!-- Custom Theme files -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
	...
	<!-- // <script type="text/javascript" src="<?php echo bloginfo('template_url'); ?>/assets/js/bootstrap-3.1.1.min.js"></script> -->
	<!-- //for bootstrap working -->
	<!-- cart -->
	<!-- // <script src="<?php echo bloginfo('template_url'); ?>/assets/js/simpleCart.min.js"> </script> -->
	<!-- cart -->
	<!-- <link rel="stylesheet" href="<?php echo bloginfo('template_url'); ?>/assets/css/flexslider.css" type="text/css" media="screen" /> -->
	<?php
	wp_head();
	?>
				...
				<div class="header-right">
					<div class="cart box_1">
						<a href="checkout.html">
							<h3> <span class="simpleCart_total"> $0.00 </span> (<span id="simpleCart_quantity" class="simpleCart_quantity"> 0 </span>)<img src="<?php echo bloginfo('template_url'); ?>/assets/images/bag.png" alt=""></h3>
						</a>
		...
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					...
					<div class="logo">
						<h1><a a href="<?php echo get_home_url(); ?>">
								<!-- <?php
											// the_custom_logo();
											?> -->
